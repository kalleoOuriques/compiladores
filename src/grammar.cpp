...
void Grammar::buildLL1Table() {
    // ======== PROGRAM ========
    // PROGRAM -> DECL_LIST
    ll1table[{"PROGRAM", "KW_INT"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_FLOAT"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_STRING"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_DEF"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_IF"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_FOR"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_RETURN"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_BREAK"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_PRINT"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "KW_READ"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "IDENT"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "LBRACE"}] = {"DECL_LIST"};
    ll1table[{"PROGRAM", "END_OF_FILE"}] = {"DECL_LIST"};
    ...
    // ======== DECL ========
    // DECL -> TYPE_SPEC IDENT DECL_TAIL
    ll1table[{"DECL", "KW_INT"}] = {"TYPE_SPEC", "IDENT", "DECL_TAIL"};
    ll1table[{"DECL", "KW_FLOAT"}] = {"TYPE_SPEC", "IDENT", "DECL_TAIL"};
    ll1table[{"DECL", "KW_STRING"}] = {"TYPE_SPEC", "IDENT", "DECL_TAIL"};
    // DECL -> KW_DEF IDENT LPAREN PARAM_LIST RPAREN BLOCK
    ll1table[{"DECL", "KW_DEF"}] = {"KW_DEF", "IDENT", "LPAREN", "PARAM_LIST", "RPAREN", "BLOCK"};
    // DECL -> STMT
    ...
    ll1table[{"STMT", "KW_FOR"}] = {"KW_FOR", "LPAREN", "FOR_INIT", "SEMICOLON", "EXPR", "SEMICOLON", "FOR_UPDATE", "RPAREN", "BLOCK"};
    // STMT -> KW_RETURN RETURN_EXPR SEMICOLON
    ll1table[{"STMT", "KW_RETURN"}] = {"KW_RETURN", "RETURN_EXPR", "SEMICOLON"};
    // STMT -> KW_BREAK SEMICOLON
    ll1table[{"STMT", "KW_BREAK"}] = {"KW_BREAK", "SEMICOLON"};
    // STMT -> KW_PRINT LPAREN EXPR RPAREN SEMICOLON
    ll1table[{"STMT", "KW_PRINT"}] = {"KW_PRINT", "LPAREN", "EXPR", "RPAREN", "SEMICOLON"};
    ...
    ll1table[{"STMT", "IDENT"}] = {"IDENT", "ASSIGN_OR_CALL"};
    // STMT -> BLOCK
    ll1table[{"STMT", "LBRACE"}] = {"BLOCK"};
    
    // ======== ASSIGN_OR_CALL ========
    // ASSIGN_OR_CALL -> LBRACKET EXPR RBRACKET ASSIGN EXPR SEMICOLON
    ll1table[{"ASSIGN_OR_CALL", "LBRACKET"}] = {"LBRACKET", "EXPR", "RBRACKET", "ASSIGN", "EXPR", "SEMICOLON"};
    // ASSIGN_OR_CALL -> ASSIGN EXPR SEMICOLON
    ll1table[{"ASSIGN_OR_CALL", "ASSIGN"}] = {"ASSIGN", "EXPR", "SEMICOLON"};
    ...
    ll1table[{"FOR_INIT", "KW_INT"}] = {"TYPE_SPEC", "IDENT", "ASSIGN", "EXPR"};
    ll1table[{"FOR_INIT", "KW_FLOAT"}] = {"TYPE_SPEC", "IDENT", "ASSIGN", "EXPR"};
    ll1table[{"FOR_INIT", "KW_STRING"}] = {"TYPE_SPEC", "IDENT", "ASSIGN", "EXPR"};
    // FOR_INIT -> IDENT ASSIGN EXPR
    ll1table[{"FOR_INIT", "IDENT"}] = {"IDENT", "ASSIGN", "EXPR"};
    // FOR_INIT -> ε
    ll1table[{"FOR_INIT", "SEMICOLON"}] = {};
    
    // ======== FOR_UPDATE ========
    // FOR_UPDATE -> IDENT ASSIGN EXPR
    ll1table[{"FOR_UPDATE", "IDENT"}] = {"IDENT", "ASSIGN", "EXPR"};
    // FOR_UPDATE -> ε
    ...
    // ======== BLOCK ========
    ll1table[{"BLOCK", "LBRACE"}] = {"LBRACE", "STMT_LIST", "RBRACE"};
    ...
    ll1table[{"REL_EXPR'", "LT"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    ll1table[{"REL_EXPR'", "GT"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    ll1table[{"REL_EXPR'", "LE"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    ll1table[{"REL_EXPR'", "GE"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    ll1table[{"REL_EXPR'", "EQ"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    ll1table[{"REL_EXPR'", "NEQ"}] = {"REL_OP", "ADD_EXPR", "REL_EXPR'"};
    // REL_EXPR' -> ε
    ...
    ll1table[{"ADD_EXPR'", "PLUS"}] = {"ADD_OP", "MULT_EXPR", "ADD_EXPR'"};
    ll1table[{"ADD_EXPR'", "MINUS"}] = {"ADD_OP", "MULT_EXPR", "ADD_EXPR'"};
    // ADD_EXPR' -> ε
    ...
    ll1table[{"MULT_EXPR'", "STAR"}] = {"MULT_OP", "UNARY_EXPR", "MULT_EXPR'"};
    ll1table[{"MULT_EXPR'", "SLASH"}] = {"MULT_OP", "UNARY_EXPR", "MULT_EXPR'"};
    ll1table[{"MULT_EXPR'", "MOD"}] = {"MULT_OP", "UNARY_EXPR", "MULT_EXPR'"};
    // MULT_EXPR' -> ε
    ...
    ll1table[{"UNARY_EXPR", "MINUS"}] = {"MINUS", "UNARY_EXPR"};
    // UNARY_EXPR -> PRIMARY
    ...
    // ======== PRIMARY ========
    ll1table[{"PRIMARY", "INT_CONST"}] = {"INT_CONST"};
    ll1table[{"PRIMARY", "FLOAT_CONST"}] = {"FLOAT_CONST"};
    ll1table[{"PRIMARY", "STRING_CONST"}] = {"STRING_CONST"};
    ll1table[{"PRIMARY", "KW_NULL"}] = {"KW_NULL"};
    // PRIMARY -> IDENT PRIMARY_TAIL
    ll1table[{"PRIMARY", "IDENT"}] = {"IDENT", "PRIMARY_TAIL"};
    ...
    ll1table[{"PRIMARY_TAIL", "LBRACKET"}] = {"LBRACKET", "EXPR", "RBRACKET"};
    // PRIMARY_TAIL -> LPAREN ARG_LIST RPAREN
    ll1table[{"PRIMARY_TAIL", "LPAREN"}] = {"LPAREN", "ARG_LIST", "RPAREN"};
    // PRIMARY_TAIL -> ε
    ...
    // ======== PARAM_LIST ========
    // PARAM_LIST -> TYPE_SPEC IDENT PARAM_LIST'
    ll1table[{"PARAM_LIST", "KW_INT"}] = {"TYPE_SPEC", "IDENT", "PARAM_LIST'"};
    ll1table[{"PARAM_LIST", "KW_FLOAT"}] = {"TYPE_SPEC", "IDENT", "PARAM_LIST'"};
    ll1table[{"PARAM_LIST", "KW_STRING"}] = {"TYPE_SPEC", "IDENT", "PARAM_LIST'"};
    // PARAM_LIST -> ε
    ll1table[{"PARAM_LIST", "RPAREN"}] = {};
    
    // ======== PARAM_LIST' ========
    // PARAM_LIST' -> COMMA TYPE_SPEC IDENT PARAM_LIST'
    ll1table[{"PARAM_LIST'", "COMMA"}] = {"COMMA", "TYPE_SPEC", "IDENT", "PARAM_LIST'"};
    // PARAM_LIST' -> ε
    ll1table[{"PARAM_LIST'", "RPAREN"}] = {};
